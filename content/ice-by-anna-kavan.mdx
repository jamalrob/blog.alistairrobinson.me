...
But in _Ice_, the experimentation and the story are inextricable. To use some technical terms of narratology (taken from the Russian formalists) and to make myself look smart: the _fabula_ is the _syuzhet_. That is, the story's telling is itself the story that is being told.
