...
The story may not be logical, but something can be said about it:
...
Maybe metafiction is not the right focus. Kavan is first and foremost _experimental_, and experimental fiction is always somewhat metafictional anyway, just because it draws attention to itself and is most of all _concerned_ with itself. But this doesn't necessarily mean that the experimental novel is _about_ itself, or about storytelling. Maybe that's true of the purest metafiction such as Italo Calvino's _If on a winter's night a traveler_, but _Ice_ is, I think, most of all interested in the the real world---it's just that _in_ the real, modern world, what is real is not always easy to work out. And when we do see the world clearly, we see that it's broken. Therefore, the kind of storytelling appropriate to the modern psychological, social, and planetary situation is not straight realism, but something reflective of entropy, fragmentation, and doom.
