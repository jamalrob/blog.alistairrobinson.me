...
The _syuzhet_ is so ambiguous that ultimately _Ice_ sabotages the reader's attempt to construct a coherent _fabula_. What is happening? When is it happening? Where is this place? Who are these people? Why are they acting this way? These questions are never answered, so the _fabula_ becomes at best a deferred hypothesis.
