...
At every level, Kavan is experimenting. Aside from the _content_---obsession, patriarchal domination and violence, the fractured personality, the apocalypse of ice and violence, to pick a few---it is _formally_ innovative, experimenting with time, character and identity, narrative point of view, and so on. But it's not experimental just for fun---there's a point to it.
...
This passage is infused with moral indignation. That's surely a good response to the Second World War, but what is remarkable is that she sees literary experimentation as a tool to oppose social evils. Walker makes the reasonable claim that this is exactly the kind of thing she is doing in _Ice_, even though it was written twenty years later.
...
* Madness, psychiatry and anti-psychiatry
