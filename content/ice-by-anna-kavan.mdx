...
So, all of this makes him look pretty bad. There's an interesting section in which he organizes the construction of a transmitter tower in a neutral country close to the war zone, designed to spread messages of peace:
...
Maybe metafiction is not the right focus. Kavan is first and foremost _experimental_, and experimental fiction is always somewhat metafictional anyway, just because it self-consciously draws attention to itself. But this doesn't necessarily mean that the experimental novel is _about_ itself, or about storytelling. This might be the case for the purest metafiction like Italo Calvino or John Barth, but _Ice_ is, I think, about the real world---it's just that _in_ the real, modern world, what is real is not always easy to work out. And when we do see the world clearly, we see that it's broken. Therefore, the kind of storytelling appropriate to the modern psychological, social, and planetary situation is not straight realism, but something reflective of entropy, fragmentation, and doom.

On the other hand, maybe storytelling is _precisely_ what _Ice_ is about, because the it is concerned with things for which narrative is significant:

### 1. The maintenance of personal identity

According to the [theory of narrative identity](https://en.wikipedia.org/wiki/Narrative_identity) in psychology, to form an identity you create a story out of your life---an internal reconstruction of disparate memories, your perception of the present, and your disposition towards the future, into a logical narrative. Kavan is interested in when this is problematic, as it is for many individuals alienated by modernity, i.e., those with mental health problems.

### 2. The connection, or disconnection, between motivation and action

A logical narrative depends on clear connections between motivations and actions. Storytelling traditionally depends on this, but the irrationality of modernity might lead us to question whether our conventional models of intention and action are correct. Does the attempted mimesis of realist fiction---in dealing with the phenomenon of obsession, the behaviour of SS death camp guards, the development of nuclear weapons, or the destructiveness of capitalism---actually represent reality at all? At the very least, shouldn't literature attempt to reflect a world in which motivations and reasons are obscure, and to show how narrative breaks down in the face of contemporary reality?
...
* The use of genres and tropes: SF, espionage, James Bond, Gothic horror, Vikings
...
- Laura de la Parra, "An Ecofeminist Reading of Anna Kavan's Ice", _Avenging Nature: The Role of Nature in Modern and Contemporary Art and Literature_
