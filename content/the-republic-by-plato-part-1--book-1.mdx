...
According Sean McAleer this centres on a pun on Socrates' name, which contains _cratos_, meaning strength or power. Even so, it alludes seriously to politics --- the powerful vs the wise but powerless --- and to the theme of persuasion by argument as opposed to force, and rational vs irrational.
...
Annas points out that this argument would have been more convincing at the time it was written than it is now, and it's a translation issue that reveals a fundamental difference between our concept of **virtue** and that of the ancient Greeks. Virtue for Plato and his contemporaries (their word was _arete_) was that which is possessed by anything --- human, animal, or inanimate object --- that enables it to do what it's meant to do. It was close to our notion of _excellence_. To say that a leopard is a good or excellent leopard is to say that it has the _arete_ that is specific to a leopard, namely that it is good at hunting antelope. To say that a knife is a good or excellent knife is to say that it has the _arete_ that is specific to a knife, namely that it is good for cutting. And to say that a human is a good or excellent human is to say that it has the _arete_ that is specific to a human, namely that it is just (among other virtues).
...
But neither Socrates nor Plato are actually committed to this final conclusion, that the just person doesn't cause harm to anyone. These arguments have been the _elenchus_ aimed at exposing the inadequacy of common sense beliefs. So the point so far in Book 1 has been to show, in Celaphus' complacency and avoidance of debate, and in Polemarchus' confusion and incoherence, that the conventionally just person is content to check off a few conventional duties but has no rational basis for this.

Socrates does want to preserve something of their positions. Their definitions are in the right ballpark, even though they're inadequate and incoherent: behind them lie intuitions that point to something greater, more important and more essential to justice than they are able to conceptualize. Their concept of justice implies things that they intuitively reject, and it is these intuitions which are right. The problem for Socrtates is that so long as justice remains for a person an intuition rather than a rational conceptualization, it is not true justice --- for that, _knowledge_ is required. This will be developed explicitly later on.
