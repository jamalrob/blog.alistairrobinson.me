...
**But note:** many of these are connected and overlap, and more importantly, there are gradations between up and down that are made explicit in the Republic, so these is continuity, not merely strict dualism. And my point above about dialectical thinking is obviously relevant here.
