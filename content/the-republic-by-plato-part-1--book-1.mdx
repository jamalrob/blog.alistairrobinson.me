...
As Julia Annas points out, talk of definitions here can be misleading. Socrates is not interested in words as such, but about things themselves, and probably doesn't see the important of distinguishing between the two. Certainly, he is not interested in how the word "justice" is commonly used, but wants to get at the thing itself, that which lies behind our common intuitions. If his aim is to find a definition it's to find what is sometimes called a _real_ definition, rather than a verbal one: a description of the nature of the thing rather than a description of the the word's signification.
