...
description: 'An article about the paradoxical strength and weakness of transcendental idealism'
date: '2024-02-20'
...
In the _Critique of Pure Reason_, Kant has both a Pelian spear and an Achilles' heel---and they're the very same thing: transcendental idealism. Not only is this his weapon in the battle against those who doubt the existence of the world around them---or the power of the human mind to know that world---but it is at the same time the weakness that guarantees he will ultimately lose. That which allows him to refute the idealist is the fatal flaw which allows others to cancel this refutation by claiming that what he has produced is just another idealism.
...
That needs some unpacking, and I'll do it with a kind of analogy. Looking at a house, I cannot see all four of its external walls, because I have a finite point of view. But I cannot help thinking that the house already comprises all its walls and aspects at once, a determinate object with more or less fixed properties, prior to and independent of my walking around it. To know the house that way, as it is in full and in itself, would surely mean grasping every aspect together, abstracted from any particular vantage point. But a grasping that belongs to no particular perspective is an absolute perception, what Kant calls *intellectual intuition*.

And now, a gap seems to have opened up. On one side, the real and complete object. On the other, what I merely experience of it, one aspect at a time. Since my experience never matches the complete specification, it looks like I only ever catch a partial glimpse of something that exists apart from experience. This is the gap in which the various sceptical idealisms.

But Kant shows the view from nowhere of intellectual intuition to be a chimera, and something of an oxymoron: having a point of view is exactly how things in the world can be accessed, so there is no higher perception for ours to fall short of. The house-in-itself, the object considered apart from any and every vantage on it, was never a coherent object of perception to begin with.

I would add that the idea of a perfect, absolute perception is a legacy of theology, and can be safely dropped. And when it's dropped, human knowledge and perception, since they no longer fall short of some imagined perfection, cannot legitimately be described as distorting or indirectly representing anything. Perception can be seen as direct, knowledge as objective.
...
So according to Kant the world around us just is _the entire field of possible experience_---and from that, no gap follows. Objects are precisely that which we can perceive and know according to our faculties.
...
(This is not only epistemology, but metaphysics too: when things become things only _for us_, that's a metaphysical position, or at least can be interpreted that way.)
...
## But this is just another form of idealism, right?
...
My response is something like _sort of, but not necessarily._ I think we should interpret Kant according to his stated intentions, and work out how his arguments fit with that. In other words, I think Kant can be saved from his tragic fate.

The key is to see the transcendental perspective not as a correction of the empirical perspective, but as a correction of transcendent metaphysics _and_ the sceptical reaction to it. It is not intended to be a superior replacement for science and ordinary experience. It is not saying _this is how reality really is_, revealing the noumena behind the veil of perception. It is not really about the world at all so much as about _us_, as experiencers in the world. Transcendental idealism is the doctrine that allows us finally to let go of the myth of absolute knowledge, and respectfully leaves our knowledge of the world intact: empirical realism is not wrong or even naive, and the shift in perspective to the transcendental is required only as a corrective to the philosophical misunderstanding of this indubitable and objective reality. In other words, it is not telling us that the ordinary and scientific descriptions of objects are wrong, that they have to be replaced --- it is explaining why speculative metaphysics cannot work regarding these objects, and obversely why sceptical doubt about their existence can no longer find purchase.