...
I read "The Death of the Author" by Roland Barthes, first published in 1967. It's one of those essays you think you don't have to read at all, like Fukuyama's "The End of History?" It is too easily encapsulated by its title and filed away in the mind without bothering with what it actually says. But a few months ago, the time came to find out for myself, and it turned out to be more interesting and strange than I expected.

Barthes argues that the meaning of a work of literature does not come from its author---that the text has *many* possible meanings, produced in the act of reading. The author as the source of meaning turns out to have been a cultural invention, imposing limits on interpretation.
...
- [Agreement and Dissent](#agreement-and-dissent)
- [Section by Section](#section-by-section)
  - [1. The reality: we cannot say who is speaking](#1-the-reality-we-cannot-say-who-is-speaking)
  - [2. The modern invention of the Author](#2-the-modern-invention-of-the-author)
  - [3. The empire of the Author has already begun to crumble](#3-the-empire-of-the-author-has-already-begun-to-crumble)
  - [4. Contemporary literature: the scriptor replaces the Author](#4-contemporary-literature-the-scriptor-replaces-the-author)
  - [5. The text as a tissue of quotations](#5-the-text-as-a-tissue-of-quotations)
  - [6. Revolution: against the empire of Critic and Author](#6-revolution-against-the-empire-of-critic-and-author)
  - [7. The Author makes way for the reader](#7-the-author-makes-way-for-the-reader)
- [The Evidence](#the-evidence)
  - [The Glutton (2023)](#the-glutton-2023)
  - [Ice (1967)](#ice-1967)
...
NOTE: Barthes' essay consists of seven sections, each a single paragraph. There are no numbers or headings in the text itself, so the ones I'm using in the section-by-section analysis are mine.

<a name="agreement-and-dissent"></a>
...
<a name="section-by-section"></a>

## Section by Section

<a name="1-the-reality-we-cannot-say-who-is-speaking"></a>
...
That speaking source is nullified in writing, and all that is left is the unique "special voice" confined to the words on the page, a depersonalized voice "consisting of several indiscernible voices". So what he briefly calls the special voice of literature is not really a voice at all in the ordinary sense he is otherwise using. Instead of a single origin, it is an irreducible plurality. And because voice has traditionally served as the anchor of meaning, a plurality of voice implies a plurality of meaning.

The essay begins very helpfully with a concrete instance of the semantic multiplicity that is so fundamental to the whole essay. Looking at the sentence from Balzac, Barthes offers several plausible answers to the question, "Who is speaking in this way?" 
...
A transitive verb is one that has an object---the verb in "She chopped an onion" takes the object "an onion"---so an intransitive verb is one that does not take an object, or does not need to, as in "She cried". Barthes uses this grammatical term for narrative with no effect beyond itself, as in novels and plays. But he doesn't mean it to include only art for art's sake; entertainment is intransitive too, because an effect only counts as external to the narrative if it could be achieved some other way, with the narrative serving the effect instrumentally. Storytelling in ritual, magic, and propaganda works this way, aiming at an effect separate from the telling of the story. Art for art's sake and sheer entertainment produce no such separate effect.

Though it's just a tangent, I can't help answering the objection that entertainment also aims for separable effects, such as making money.

The answer is that money-making is a different kind of thing from the effect a novel has on its readers. It applies equally to selling shoes, and therefore says nothing distinctive about what a story does. A story does not in itself aim to make money but to divert, excite, captivate, and so on. Making money is a secondary effect.
...
<a name="3-the-empire-of-the-author-has-already-begun-to-crumble"></a>


### 3. The empire of the Author has already begun to crumble

Barthes identifies several precursors of the author's death: Mallarmé, Valéry, and Proust. He also points to Surrealism and outside literature to linguistics, which in their own ways moved in the same direction.

Mallarmé anticipated the idea back in the 19th century:

> The pure work implies the disappearance of the poet’s own utterance, which instead yields the initiative to the words, through the collision of their activated unevenness: they light one another up with reciprocal reflections like a virtual trail of fire over precious stones, replacing the perceptible breath with the lyric inspiration of old or the rapturous personal course of the sentence.
>
...
He is referring to Émile Benveniste’s essay, “The Nature of Pronouns”, which was published in 1966, just before Barthes wrote “The Death of the Author”.

> "I" can only be defined by the instance of discourse that contains it and by that alone. It has no value except in the instance in which it is produced. But in the same way it is also as an instance of form that I must be taken; the form of I has no linguistic existence except in the act of speaking in which it is uttered.
>
...
- **Historical:** the death of the Author is a historical phenomenon.
- **Enacted:** the death of the Author is an act of writing and reading.

What we find in thinkers and commentators who reacted to and built upon this essay is that the transcendental ontology is dropped, but in two different ways. Foucault historicizes it: he replaces Barthes' Author with the **author-function**, which makes it explicitly a cultural role (something only inconsistently implicit in Barthes’ essay), significant in some contexts but not in others. Others, like Seán Burke, go further and reject the ontology as never having described anything real to begin with, such that Barthes' Author was a straw man: a "metaphysical abstraction, a Platonic type, a fiction of the absolute", as Burke put it.
<br><br>
...
The Author, Barthes says, is conceived as the parent of the work, its prior condition. Thus we have a certain temporal conception of the work of literature. When the Author is replaced with the scriptor, that no longer holds:
...
This might appear to contradict intransitivity as described in section 2, because each of the examples is transitive. Firing or sentencing someone and initiating a debt are all real effects on the world, external to their performative enunciation. But when Barthes uses the term, he is not using it for this feature. He is making use of the fact that performatives don't describe a state of affairs that already existed; they bring one into being in the act of being said. Literary writing can do this without any external effect at all---it constitutes *its own* content, rather than transmitting a reality that came before it.

So Barthes takes this concept from linguistics and the philosophy of language and extends it to cover literary writing: writing is not a record or a depiction, but a generative act. Now, obviously such works contain descriptions and representation, functioning as such within the confines of the story, but the point is that the work as a whole is not a recording or transmission of something prior. It constitutes itself in the act of being written, rather than being extruded out from some source.
...
Where the Author's hand was slow, struggling with thoughts too large for it, the scriptor's hand...

> detached from any voice, borne by a pure gesture of inscription (and not of expression), traces a field without origin---or which, at least, has no other origin than language itself, that is, the very thing which ceaselessly questions any origin.
...
<a name="5-the-text-as-a-tissue-of-quotations"></a>
...
What does this shift feel like, in practice, to a reader? For me, it provides conceptual tools but it doesn't really help me in the practice of reading, simply because---as I said early in the article---I am already averse to deciphering. The writers I like are those who revel in language and form, the multiplicity of meaning, and the instability of a story’s source: Nabokov, Borges, John Barth, Samuel R. Delany. Like Proust, these authors are meticulous linguistic engineers, but they're aware of their lack of complete control over how their work is received. And why would an author *not* take pleasure in the independent life of their work?

> To give a text an Author is to impose a limit on that text, to furnish it with a final signified, to close the writing. Such a conception suits criticism very well, the latter then allotting itself the important task of discovering the Author (or its hypostases: society, history, psyche, liberty) beneath the work

Barthes is against limits, both on the writing and on the reader's interpretation. Such limits happen when meaning is assigned to an ultimate origin, centrally the Author but also other candidate origins such as “society, history, psyche, liberty”, which function in the same way as the Author---are in effect the Author in disguise.
...
<a name="7-the-author-makes-way-for-the-reader"></a>

### 7. The Author makes way for the reader

Barthes returns to the question from section 1, “Who is speaking?”. Here he supplies the answer:

> No one, no 'person', says it: its source, its voice, is not the true place of the writing, which is reading.

As he shows with the example of Greek tragedy, the “true locus of writing” is the point where meaning happens, where the symbolic threads of the text come together. It is the perspective on the text from which everything can potentially be seen, and the only thing with this power and role is the reader.
...
The hostile critics of new writing are accused of "antiphrasis", which means they say the opposite of what they mean. So-called good society praises the very things that its actual practice ignores, smothers, and destroys: literature, meaning, and the reader.

He ends not by restating the thesis or summarizing the argument, but with an exhortation---a call to arms, telling the reader what is to be done.
...
This is a serious challenge to Authorial intention as a category. It presupposes a stable Author whose intentions could in principle be recovered, if we did enough digging. But Ballard’s later conflicting comments suggest there is no such Author. There is a series of Ballards, each offering an interpretation, none with privileged access to the work's meaning. His interpretations were not better than anyone else’s merely by virtue of being his.

In my commentary on section 4 I promised I would come back to a point to clarify it with the help of Ballard. The point was that when we refer to an author by name, we are often referring to the standpoint of the text rather than to the person. In the case of *Crash*, using "Ballard" to refer to the novel's own narrative or artistic agency is, as a matter of empirical fact, going to be more reliable than using it to refer to the man, whose understanding of his own work changed so much over the years. More than that, when we discuss the novel and talk about what Ballard *does* in it, we are in fact primarily referring to that internal standpoint anyway, not to any human being---even if we are not quite aware of this.

I can imagine an objection: even if there were many later Ballards, each with a different interpretation of the novel, it's a fact that only one of them wrote it, and that is where we need to look to find the meaning: Ballard as he was when he was writing it.

There are two ways of answering this that I can see: one epistemic, the other ontological. The epistemic response is that even if it's true to say there was a Ballard at some point whose mind contained the meaning of *Crash*, we have no way to reach it except through unreliable testimony, primarily Ballard's own, so we could never know when we *do* reach it. And this is not just a contingent state of affairs; it is *necessarily* the case. The state of mind of Ballard-while-writing-Crash is *in principle* not recoverable, because every report of what he thought at the time of writing it must come from a later Ballard (at best).

The ontological answer undermines the objection more thoroughly, because it denies what the epistemic answer accepts, that there was a determinate and coherent state of mind belonging to Ballard just prior to his writing the novel---one which the text then reliably recorded, such that a sufficiently attentive reading could recover it. But there is no reason to believe there was a single meaning or motivation at all, *except under the assumption of the figure of the all-powerful Author*. Since the scriptor is the better concept of the writing subject, we can say that the writing did not follow the meaning; the writing was how the meaning first came to exist at all.
...
That's the answer for the essay itself, but the question was general. What about a novel?

Not everything about an author is off limits, even for Barthes. Knowing that Cervantes spent years captive in Algiers is important context, not decipherment. Disentangling doesn't require that we forget the actual writer. The line is somewhere else: between letting contextual facts enrich and inform a reading, as one thread among others, and letting any one of them fix the reading, closing off every other thread. The Proust case earlier in this article is the model for this: his intentions carried through, and Barthes' position was not weakened by that fact, because a coincidence between intention and interpretation is not the same as an intention that determines it.
...
- Benveniste, Émile. "The Nature of Pronouns." *Problems in General Linguistics*, translated by Mary Elizabeth Meek, University of Miami Press, 1971, pp. 217–222.
- Burke, Seán. *The Death and Return of the Author: Criticism and Subjectivity in Barthes, Foucault and Derrida*. Edinburgh UP, 1992.
- Coke-Enguídanos, Mervyn. "Towards a Poetry of Silence: Stéphane Mallarmé and Juan Ramón Jiménez." *Studies in 20th Century Literature*, vol. 7, no. 2, 1983, article 5.
...
- Kavan, Anna. *Ice*. Peter Owen, 1967.
- Wilde, Oscar. Preface. *The Picture of Dorian Gray*, 1891.