...
Once the creature has been incapacitated by the ordinary methods, the following points must be observed. _Note that proper disposal is mandatory, since destruction by itself is not permanent._
