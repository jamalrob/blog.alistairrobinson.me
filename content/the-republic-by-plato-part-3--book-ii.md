...
draft: false
---
Thrasymachus has been defeated, but the others are not satisfied. Book II begins with Glaucon's challenge, which is then reinforced by Adeimantus, after which Socrates launches on his long answer, taking up the rest of the book, starting with the construction of a hypothetical city.
...
Socrates has shown that a just person tends to be good and wise, but he hasn't secured the premise that justice is the soul's excellence (virtue or *arete*) that allows it to perform the soul's function (*ergon*) well, i.e., to enable living well and therefore happiness. Presumably *something* is the soul's virtue that makes this possible, i.e., its *proper virtue*, but Socrates hasn't established that it's justice. It could be wisdom. That is, wisdom could be the excellence of the soul that enables a person to live well, while justice is just a by-product of wisdom.
...
It may be true that justice is valued both as an instrumental and an intrinsic good, but it's the latter that really matters. It's only the latter that can uphold the dignity of justice that Glaucon feels intuitively but cannot articulate. And it's only the latter that can refute Thrasymachus.
...
And, so the argument goes, anyone would do the same if they could. If they are just, it is because they are forced to be, and they are too weak to pursue their own interests. Justice is always practiced unwillingly.

Glaucon claims that a simple thought-experiment demonstrates this:
