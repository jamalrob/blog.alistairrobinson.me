...
So we have two incommensurable attitudes confronting each other: on one side, the ends in themselves are production, profit, growth, and economic development; on the other, we have emancipation and an end to suffering and domination. But they are not quite equal: in conditions where the former attitude is dominant, the question will be asked as to how the latter ends _serve as means to the former ends_.
