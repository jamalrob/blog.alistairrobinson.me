...
Earth, we learn, is now virtually a toxic dump, and New Tahiti represents something of a new start. But the first order of business is logging; back on treeless Earth, timber is now worth more than gold. After that's done, the plan is to intensively farm the cleared land and build a world fit for Terrans. Whether stripping away the forests is likely to support a sustainable agriculture, and whether the native inhabitants are happy with all this, are questions the Terrans are mostly unconcerned with. 
