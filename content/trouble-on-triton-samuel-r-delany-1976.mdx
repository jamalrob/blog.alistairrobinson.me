...
It might be worth breaking that down a bit. The idea in the book is that classical, deductive logic, which has long been thought by philosophers to be the pinnacle or model of rationality, actually works for only a very restricted set of simple problems (and this is widely accepted today). Human reality is much messier, requiring informal deductive and abductive reasoning. Delaney's metalogic comes in at this point to deal with this messy reality with the practical application of a non-classical formal system.
