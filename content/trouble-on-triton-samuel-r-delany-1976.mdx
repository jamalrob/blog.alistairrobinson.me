...
1. Gender, sexuality, and _épistémè_ (I'm using the French orthography not to be pretentious but to distinguish the term from the more general philosophical use of the word that goes back to Plato and Aristotle)
