...
I questioned my own motivation in wanting to correctly label the book, but I don't regret it. The quest for a definition and the instinct to classify, even if they cannot be ultimately satisfied, constitute a _way in_---towards a clearer, deeper appreciation.
