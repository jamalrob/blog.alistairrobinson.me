...
My first reaction to this was, “Is that it?” But of course, the simplicity is precisely the point. Two notes, linked in both directions and easily navigable in Obsidian, form a relationship. When a third is added, a pattern begins to form, an emergent bottom-up architecture.

![A fully connected cluster in Obsidian](/bucket/obsidian-connected-triad.jpg)
*A fully connected cluster in Obsidian*

What makes this so powerful is simple reciprocity. With links and backlinks combined, notes can see each other, and they stop being mere items in some higher-level list.
...
I don't think it's too grandiose to say that my notes became a thinking environment.
