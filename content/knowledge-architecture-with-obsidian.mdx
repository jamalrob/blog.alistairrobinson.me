...
Instead of writing standalone documents, I now build clusters of meaning. That may sound pretentious, but it isn’t meant to be; it’s simply what actually happens when notes start relating to each other. Each link adds context, each backlink reveals a line of thought, and each cluster gives shape to some domain of knowledge or activity.
