...
Whether or not that implies I possess a disordered soul, Thrasymachus is surely right to question the notion that a practitioner of a craft never aims at their own benefit. This flies in the face of common sense and raises the suspicion that Socrates has used some sleight of hand.

That might be unfair, but Socrates certainly is working with a controversial concept of craft, one that makes his conclusion inevitable.
...
The latter conception is surely the intuitive one, certainly in the modern world. The trouble is, since we are also accepting that ruling and justice are crafts, then we have to say that they are basically self-interested, and we end up with a view that is either entirely immoralist---if we side with the ruler---or entirely pessimistic and cynical.

This is why we need to be patient: Socrates will show us another way.
<a name="elenchus-one"><br/></a>
## Second elenchus
