...
But in statement (3), the agent might be anyone, including the ruler---so _the other_ can be either too. As one of the ruled, one is just when one acts to benefit the ruler; as the ruler, one is just when one acts to benefit the people. Thrasymachus will criticize acting justly in both cases, and will praise tyrants as exercising the most complete injustice.
