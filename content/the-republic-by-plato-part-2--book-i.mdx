...
What isn't immediately obvious is that statement 1 is indexical---indexed to the agent's standpoint, where the agent is assumed not to be the ruler. This is about what is best from one's own point of view as the person who is acting justly, so _the stronger_ means _the one who is stronger than oneself_. So, to act justly is to act to the advantage of who is more powerful than oneself.

But in statement 3, the agent might be either, so _the other_ can also be either. As the subject of a ruler, one is just when one acts to benefit the ruler; as the ruler, one is just when one acts to benefit the people---Thrasymachus will praise tyrants as exercising complete injustice.
