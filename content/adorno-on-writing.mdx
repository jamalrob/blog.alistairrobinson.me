...
draft: true
---
The brilliant and beautiful Reflection 51 of Theodor Adorno's _Minima Moralia_, carrying the heading "Memento", is all about writing. Uncharacteristically for this famously difficult philosopher, it begins with eminently reasonable observations and practical advice. Even more unusually, these observations and pieces of advice are quite familiar: kill your darlings, avoid cliché, revise revise revise, and so on. 

But it swiftly moves into darker and more philosophically sophisticated territory. In this post I'll analyze the whole thing.
...
This is "kill your darlings," but argued persuasively with originality and depth. You have to discriminate, not just write down everything that occurs to you to fill up the page with attractive verbiage. The interesting point is that you have to discard, not only the ideas that are useless or bad, but also the fertile ones. And discarding them 
