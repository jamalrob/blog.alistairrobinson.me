...
import { imageLocation, bodyImage } from 'myconfig'
...
function myMatter(fileContents) {
    ...
    */
    ...
    let contentWithImgUrls = content.replaceAll('/bucket/', `${imageLocation}/tr:w-${bodyImage.width},q-${bodyImage.quality}/`);
...
export async function getPost(slug, dir='content') {
